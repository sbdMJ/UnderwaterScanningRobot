...
- [x] 시나리오 ③ depth-hold 폐루프 (소형 수조) — **진동 기준 합격** (2026-08-19
      ...
      `method:=ssi`도 합격 (bag 01_11: 오프셋 +1.0 cm vs nominal +4.2 —
      원인 ⑩ 수정 후 적응이 구조 잔차를 흡수). **시나리오 ③ 완전 종결** —
      다음: 마커 리깅 시 ③ 본문 승격, 또는 본 탱크 E-③ 착수
