...
- [x] 시나리오 ③ depth-hold 폐루프 (소형 수조) — **진동 기준 합격** (2026-08-19
      ...
      근본원인 ①–⑨ 동시 현장 검증; E-② 행 참조). 마커리스 변형 기준 — 남은
      마무리: 의도적 10 cm push-release 1회 + `method:=ssi` 재시도 (+3~6 cm
      편측 오프셋을 SSI 잔차 학습이 흡수하는지 = nominal-vs-adaptive 논문 포인트)
